...
import { GetToken, GetTokenAndValidate, IsActive, IsExpired, RefreshTokenData } from "../../shared";
...
declare class RefreshTokenService extends Service {
	 ...
	 * @returns {RefreshTokenData}
	 */
	public getTokenAndValidate(ctx: Context<GetTokenAndValidate>): Promise<RefreshTokenData>
}
